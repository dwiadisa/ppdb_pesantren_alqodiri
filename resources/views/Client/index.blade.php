...
<head>
    ...
    {!! SEOMeta::generate() !!}
    {!! OpenGraph::generate() !!}
    <link rel="icon" type="image/x-icon" href="{{asset('assets/images/img/logo_aqj.png')}}">
            ...
            <div class="container">
                <div class="wrapper__syarat">
                    ...
                    <div class="content__syarat__image">
                        <img src="{{$dataImageSyaratPendaftaran ? asset('content_images/' . $dataImageSyaratPendaftaran->image_syarat) : asset('assets/images/img/pendaftaran.jpg')}}"
                            alt="pendaftaran" />
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="wrapper__informasi__pelayanan">
                    <div class="content__informasi__pelayanan__image">
                        <img src="{{$dataImageInformasiPelayanan ? asset('content_images/' . $dataImageInformasiPelayanan->image_informasi) : asset('assets/images/img/pendaftaran.jpg')}}"
                        ...
                        <div class="accordion__wrapper">
                            <div class="accordion">
                                ...
                                <div class="accordion__content">
                                    <p>Tanggal:</p>
                                    <span>{{$dataInformasiPelayanan && $dataInformasiPelayanan->dari_tanggal_pembukaan_pendaftaran ? Carbon::parse($dataInformasiPelayanan->dari_tanggal_pembukaan_pendaftaran)->format('d-M-Y') : '-'}}
                                        ~
                                        {{$dataInformasiPelayanan && $dataInformasiPelayanan->sampai_tanggal_pembukaan_pendaftaran ? Carbon::parse($dataInformasiPelayanan->sampai_tanggal_pembukaan_pendaftaran)->format('d-M-Y') : '-'}}</span>
                                    <p>Layanan Putra:</p>
                            ...
                            <div class="accordion">
                                ...
                                <div class="accordion__content">
                                    <p>Tanggal:</p>
                                    <span>{{$dataInformasiPelayanan && $dataInformasiPelayanan->dari_tanggal_verifikasi_berkas ? Carbon::parse($dataInformasiPelayanan->dari_tanggal_verifikasi_berkas)->format('d-M-Y') : '-'}}
                                        ~
                                        {{$dataInformasiPelayanan && $dataInformasiPelayanan->sampai_tanggal_verifikasi_berkas ? Carbon::parse($dataInformasiPelayanan->sampai_tanggal_verifikasi_berkas)->format('d-M-Y') : '-'}}</span>
                            ...
                            <div class="accordion">
                                ...
                                <div class="accordion__content">
                                    <p>Pagi:</p>
                                    <span>{{$dataInformasiPelayanan && $dataInformasiPelayanan->dari_pelayanan_waktu_pagi ? Carbon::parse($dataInformasiPelayanan->dari_pelayanan_waktu_pagi)->format('H:i') : '-'}}~
                                        {{$dataInformasiPelayanan && $dataInformasiPelayanan->sampai_pelayanan_waktu_pagi ? Carbon::parse($dataInformasiPelayanan->sampai_pelayanan_waktu_pagi)->format('H:i') : '-'}}
                                        WIB</span>
                                    <p>Siang:</p>
                                    <span>{{$dataInformasiPelayanan && $dataInformasiPelayanan->dari_pelayanan_waktu_siang ? Carbon::parse($dataInformasiPelayanan->dari_pelayanan_waktu_siang)->format('H:i') : '-'}}
                                        ~
                                        {{$dataInformasiPelayanan && $dataInformasiPelayanan->sampai_pelayanan_waktu_siang ? Carbon::parse($dataInformasiPelayanan->sampai_pelayanan_waktu_siang)->format('H:i') : '-'}}
                                        WIB</span>
                                </div>
                            </div>
                        </div>
        ...
        <footer>
            <svg id="wave" style="transform: rotate(180deg); transition: 0.3s" viewBox="0 0 1440 100" version="1.1"
                ...
                <defs>
                    <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
                        <stop stop-color="rgba(255, 242.673, 242.673, 1)" offset="0%"></stop>
                        <stop stop-color="rgba(253.043, 253.043, 253.043, 1)" offset="100%"></stop>
                    </linearGradient>
                </defs>
                    ...
                    <div class="sosmed__footer">
                        ...
                        <ul>
                            <li>
                                ...
                                <a href="{{$dataGeneral->facebook_pondok ?? '-'}}" target="_blank">Facebook</a>
                            </li>
                            <li>
                                <i class="fa-brands fa-square-instagram"></i>
                                <a href="{{$dataGeneral->instagram_pondok ?? '-'}}" target="_blank">Instagram</a>
                            </li>
                            <li>
                                <i class="fa-brands fa-youtube"></i>
                                <a href="{{$dataGeneral->youtube_pondok ?? '-'}}" target="_blank">Youtube</a>
                            </li>
                            <li>
                                <i class="fa-brands fa-tiktok"></i>
                                <a href="{{$dataGeneral->tiktok_pondok ?? '-'}}" target="_blank">Tiktok</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="footer__copyright">
                <span>
                    ...
                    <a target="_blank" href="https://refitrihidayatullah.github.io/">Refi Tri Hidayatullah</a>
                </span>
            </div>
        </footer>
        <!-- footer end -->
